...
func (pr *ProductRepository) GetProduct(ctx context.Context) ([]db.Product, error) {
	return pr.db.ListProduct(ctx)
}

func (pr *ProductRepository) GetProductById(ctx context.Context, id int32) (db.Product, error) {
